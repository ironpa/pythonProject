...
class Ui_mw_Main(object):
    def setupUi(self, mw_Main):
        ...
        self.pb_open_file.setIconSize(QSize(16, 16))
        ...
        self.pb_image_description.setIconSize(QSize(20, 20))
        ...
        icon5 = QIcon()
        icon5.addFile(u":/editors/icons8-rotate-80.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_rotate.setIcon(icon5)
        ...
        self.pb_rotate_right.setIconSize(QSize(30, 35))
        ...
        icon6 = QIcon()
        icon6.addFile(u":/editors/icons8-rotate-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_rotate_left.setIcon(icon6)
        self.pb_rotate_left.setIconSize(QSize(35, 30))
        ...
        icon7 = QIcon()
        icon7.addFile(u":/editors/icons8-flip-vertical-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_flip.setIcon(icon7)
        self.pb_flip.setIconSize(QSize(35, 30))
        ...
        icon8 = QIcon()
        icon8.addFile(u":/editors/icons8-wand-50.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_enhance.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/editors/icons8-detail-100.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_detail.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/editors/icons8-grayscale-48.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_grayscale.setIcon(icon10)
        self.pb_grayscale.setIconSize(QSize(28, 28))
        ...
        icon11 = QIcon()
        icon11.addFile(u":/editors/icons8-cleanup-noise-50.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_smooth.setIcon(icon11)
        self.pb_smooth.setIconSize(QSize(30, 30))
        ...
        icon12 = QIcon()
        icon12.addFile(u":/editors/icons8-invert-colors-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_invert_colors.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/editors/icons8-sharp-80.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_sharpen.setIcon(icon13)
        self.pb_sharpen.setIconSize(QSize(30, 30))
        ...
        icon14 = QIcon()
        icon14.addFile(u":/editors/icons8-broken-bottle-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_find_edges.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/editors/icons8-3d-touch-80.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_emboss.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/editors/icons8-filter-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_blur.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/editors/icons8-kernel-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_kernel.setIcon(icon17)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/editors/icons8-crop-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_resize.setIcon(icon18)
        ...
        icon19 = QIcon()
        icon19.addFile(u":/editors/icons8-cut-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_crop.setIcon(icon19)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/editors/icons8-rgb-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_showRGB.setIcon(icon20)
        ...
        icon21 = QIcon()
        icon21.addFile(u":/editors/icons8-electrical-threshold-100.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_threshold.setIcon(icon21)
        ...
        icon22 = QIcon()
        icon22.addFile(u":/main/icons8-revert-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_revert.setIcon(icon22)
        ...
        icon23 = QIcon()
        icon23.addFile(u":/editors/icons8-trash-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_clear.setIcon(icon23)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 918, 533))
