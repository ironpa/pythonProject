...
class Ui_mw_Main(object):
    def setupUi(self, mw_Main):
        ...
        icon7 = QIcon()
        icon7.addFile(u":/editors/icons8-detail-100.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_detail.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/editors/icons8-grayscale-48.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_grayscale.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/editors/icons8-cleanup-noise-50.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_smooth.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/editors/icons8-invert-colors-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_invert_colors.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/editors/icons8-sharp-80.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_sharpen.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/editors/icons8-broken-bottle-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_find_edges.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/editors/icons8-3d-touch-80.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_emboss.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(u":/editors/icons8-filter-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_blur.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/editors/icons8-kernel-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_kernel.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(u":/editors/icons8-crop-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_resize.setIcon(icon16)
        ...
        icon17 = QIcon()
        icon17.addFile(u":/editors/icons8-cut-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_crop.setIcon(icon17)
        ...
        icon18 = QIcon()
        icon18.addFile(u":/editors/icons8-rgb-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_showRGB.setIcon(icon18)
        ...
        icon19 = QIcon()
        icon19.addFile(u":/editors/icons8-electrical-threshold-100.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_threshold.setIcon(icon19)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/main/icons8-revert-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_revert.setIcon(icon20)
        ...
        icon21 = QIcon()
        icon21.addFile(u":/editors/icons8-trash-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_clear.setIcon(icon21)
