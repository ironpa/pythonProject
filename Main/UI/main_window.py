...
class Ui_mw_Main(object):
    def setupUi(self, mw_Main):
        ...
        self.fb_group_box.setMinimumSize(QSize(0, 60))
        ...
        self.pb_open_file.setMinimumSize(QSize(30, 0))
        self.pb_open_file.setMaximumSize(QSize(50, 50))
        icon3 = QIcon()
        icon3.addFile(u":/menu/icons8-opened-folder-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_open_file.setIcon(icon3)
        self.pb_open_file.setIconSize(QSize(32, 32))
        ...
        sizePolicy2.setHeightForWidth(self.pb_image_description.sizePolicy().hasHeightForWidth())
        self.pb_image_description.setSizePolicy(sizePolicy2)
        self.pb_image_description.setMinimumSize(QSize(30, 50))
        self.pb_image_description.setMaximumSize(QSize(50, 50))
        icon4 = QIcon()
        icon4.addFile(u":/menu/icons8-information-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_image_description.setIcon(icon4)
        self.pb_image_description.setIconSize(QSize(32, 32))
        ...
        sizePolicy3.setHeightForWidth(self.pb_rotate_right.sizePolicy().hasHeightForWidth())
        self.pb_rotate_right.setSizePolicy(sizePolicy3)
        self.pb_rotate_right.setMinimumSize(QSize(50, 50))
        self.pb_rotate_right.setMaximumSize(QSize(50, 50))
        self.pb_rotate_right.setIcon(icon2)
        self.pb_rotate_right.setIconSize(QSize(32, 32))
        ...
        sizePolicy4.setHeightForWidth(self.pb_rotate_left.sizePolicy().hasHeightForWidth())
        self.pb_rotate_left.setSizePolicy(sizePolicy4)
        self.pb_rotate_left.setMaximumSize(QSize(50, 50))
        icon5 = QIcon()
        icon5.addFile(u":/editors/icons8-rotate-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_rotate_left.setIcon(icon5)
        self.pb_rotate_left.setIconSize(QSize(32, 32))
        ...
        sizePolicy5.setHeightForWidth(self.pb_flip.sizePolicy().hasHeightForWidth())
        self.pb_flip.setSizePolicy(sizePolicy5)
        self.pb_flip.setMaximumSize(QSize(50, 50))
        icon6 = QIcon()
        icon6.addFile(u":/editors/icons8-flip-vertical-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_flip.setIcon(icon6)
        self.pb_flip.setIconSize(QSize(32, 32))
        ...
        self.pb_grayscale.setMinimumSize(QSize(50, 50))
        self.pb_grayscale.setMaximumSize(QSize(50, 50))
        icon7 = QIcon()
        icon7.addFile(u":/editors/icons8-grayscale-48.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_grayscale.setIcon(icon7)
        self.pb_grayscale.setIconSize(QSize(32, 32))
        ...
        self.pb_smooth.setMinimumSize(QSize(50, 50))
        self.pb_smooth.setMaximumSize(QSize(50, 50))
        icon8 = QIcon()
        icon8.addFile(u":/editors/icons8-cleanup-noise-50.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_smooth.setIcon(icon8)
        self.pb_smooth.setIconSize(QSize(32, 32))
        ...
        self.pb_invert_colors.setMaximumSize(QSize(50, 50))
        icon9 = QIcon()
        icon9.addFile(u":/editors/icons8-invert-colors-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_invert_colors.setIcon(icon9)
        self.pb_invert_colors.setIconSize(QSize(32, 32))
        ...
        self.pb_sharpen.setMinimumSize(QSize(50, 50))
        self.pb_sharpen.setMaximumSize(QSize(50, 50))
        icon10 = QIcon()
        icon10.addFile(u":/editors/icons8-sharp-80.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_sharpen.setIcon(icon10)
        self.pb_sharpen.setIconSize(QSize(32, 32))
        ...
        self.pb_find_edges.setMinimumSize(QSize(50, 50))
        self.pb_find_edges.setMaximumSize(QSize(50, 50))
        icon11 = QIcon()
        icon11.addFile(u":/editors/icons8-broken-bottle-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_find_edges.setIcon(icon11)
        self.pb_find_edges.setIconSize(QSize(32, 32))
        ...
        self.pb_emboss.setMinimumSize(QSize(50, 50))
        self.pb_emboss.setMaximumSize(QSize(50, 50))
        icon12 = QIcon()
        icon12.addFile(u":/editors/icons8-3d-touch-80.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_emboss.setIcon(icon12)
        self.pb_emboss.setIconSize(QSize(32, 32))
        ...
        self.pb_blur.setMaximumSize(QSize(50, 50))
        icon13 = QIcon()
        icon13.addFile(u":/editors/icons8-filter-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_blur.setIcon(icon13)
        self.pb_blur.setIconSize(QSize(32, 32))
        ...
        self.pb_kernel.setMaximumSize(QSize(50, 50))
        icon14 = QIcon()
        icon14.addFile(u":/editors/icons8-kernel-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_kernel.setIcon(icon14)
        self.pb_kernel.setIconSize(QSize(32, 32))
        ...
        self.pb_resize.setMaximumSize(QSize(50, 50))
        icon15 = QIcon()
        icon15.addFile(u":/editors/icons8-crop-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_resize.setIcon(icon15)
        self.pb_resize.setIconSize(QSize(32, 32))
        ...
        self.pb_crop.setMaximumSize(QSize(50, 50))
        icon16 = QIcon()
        icon16.addFile(u":/editors/icons8-cut-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_crop.setIcon(icon16)
        self.pb_crop.setIconSize(QSize(32, 32))
        ...
        self.pb_revert.setMinimumSize(QSize(50, 50))
        self.pb_revert.setMaximumSize(QSize(50, 50))
        icon18 = QIcon()
        icon18.addFile(u":/main/icons8-revert-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_revert.setIcon(icon18)
        self.pb_revert.setIconSize(QSize(32, 32))
        ...
        icon19 = QIcon()
        icon19.addFile(u":/editors/icons8-trash-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.pb_clear.setIcon(icon19)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1090, 515))
        ...
        sizePolicy8.setHeightForWidth(self.qt_image_description.sizePolicy().hasHeightForWidth())
        self.qt_image_description.setSizePolicy(sizePolicy8)
        ...
        sizePolicy8.setHeightForWidth(self.ql_coordinates.sizePolicy().hasHeightForWidth())
        self.ql_coordinates.setSizePolicy(sizePolicy8)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1116, 24))
...
#if QT_CONFIG(tooltip)
        self.pb_revert.setToolTip(QCoreApplication.translate("mw_Main", u"Revert changes to an image", None))
#endif // QT_CONFIG(tooltip)
